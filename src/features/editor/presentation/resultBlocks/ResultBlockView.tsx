...
export function ResultBlockView({
  ...
  return (
    ...
    >
      {block.type === "roll" && (
        <RollResultBlock block={block} selected={selected} />
      )}
      {block.type === "oracle" && (
        <OracleResultBlock
          block={block}
      ...
      {block.type === "combat" && (
        <CombatResultBlock block={block} selected={selected} />
      )}
      {block.type === "stat" && (
        <StatResultBlock block={block} selected={selected} />
      )}
      {block.type === "chaos" && (
        <ChaosResultBlock block={block} selected={selected} />
      )}
      {block.type === "error" && (
        <ErrorResultBlock block={block} selected={selected} />
      )}
    </NodeViewWrapper>
  );
}
